...
<a href="#" onclick="Effect.toggle('sermon-list-<?php the_ID(); ?>', 'slide'); return false;"><?php
...
<h2 class="series-date"><?php echo date('F j', $dateMeta1);
if ( get_post_meta($post->ID, 'week21_date', true) ) {
echo ' through ';
...
<?php if ( is_single() ) : ?>
<div id="sermon-list-<?php the_ID(); ?>" class="sermon-list">
<?php else: ?>
...
<?php
if ( get_post_meta($post->ID, 'week1_audio', true) ) :
$audioMeta1 = get_post_meta($post->ID, 'week1_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week1_date; ?></span> | <span class="speaker"><?php meta('week1_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week1_passage') ?></span></p>
...
<a title="Download <?php meta('week1_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week1_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week1_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week1_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week1_vimeo_id') ?>"> <img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week1_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week1_pdf_id); ?>" href="<?php echo $week1_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>

<?php
if ( get_post_meta($post->ID, 'week2_audio', true) ) :
$audioMeta2 = get_post_meta($post->ID, 'week2_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week2_date; ?></span> | <span class="speaker"><?php meta('week2_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week2_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week2_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week2_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week2_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week2_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week2_vimeo_id') ?>"> <img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week2_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week2_pdf_id); ?>" href="<?php echo $week2_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week3_audio', true) ) :
$audioMeta3 = get_post_meta($post->ID, 'week3_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week3_date; ?></span> | <span class="speaker"><?php meta('week3_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week3_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week3_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week3_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week3_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week3_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week3_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week3_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week3_pdf_id); ?>" href="<?php echo $week3_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week4_audio', true) ) :
$audioMeta4 = get_post_meta($post->ID, 'week4_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week4_date; ?></span> | <span class="speaker"><?php meta('week4_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week4_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week4_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week4_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week4_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week4_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week4_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week4_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week4_pdf_id); ?>" href="<?php echo $week4_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week5_audio', true) ) :
$audioMeta5 = get_post_meta($post->ID, 'week5_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week5_date; ?></span> | <span class="speaker"><?php meta('week5_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week5_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week5_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week5_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week5_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week5_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week5_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week5_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week5_pdf_id); ?>" href="<?php echo $week5_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week6_audio', true) ) :
$audioMeta6 = get_post_meta($post->ID, 'week6_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week6_date; ?></span> | <span class="speaker"><?php meta('week6_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week6_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week6_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week6_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week6_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week6_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week6_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week6_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week6_pdf_id); ?>" href="<?php echo $week6_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week7_audio', true) ) :
$audioMeta7 = get_post_meta($post->ID, 'week7_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week7_date; ?></span> | <span class="speaker"><?php meta('week7_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week7_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week7_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week7_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week7_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week7_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week7_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week7_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week7_pdf_id); ?>" href="<?php echo $week7_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week8_audio', true) ) :
$audioMeta8 = get_post_meta($post->ID, 'week8_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week8_date; ?></span> | <span class="speaker"><?php meta('week8_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week8_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week8_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week8_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week8_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week8_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week8_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week8_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week8_pdf_id); ?>" href="<?php echo $week8_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week9_audio', true) ) :
$audioMeta9 = get_post_meta($post->ID, 'week9_audio', true);
...
<p class="sermon-details"><span class="date"><?php echo $week9_date; ?></span> | <span class="speaker"><?php meta('week9_speaker') ?></span> | 
<span class="passage">Scripture: <?php meta('week9_passage') ?></span></p>
<div class="sermon-media">
...
<a title="Download <?php meta('week9_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week9_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week9_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week9_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week9_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week9_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week9_pdf_id); ?>" href="<?php echo $week9_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week10_audio', true) ) :
$audioMeta10 = get_post_meta($post->ID, 'week10_audio', true);
...
<a title="Download <?php meta('week10_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week10_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week10_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week10_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week10_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week10_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week10_pdf_id); ?>" href="<?php echo $week10_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week11_audio', true) ) :
$audioMeta11 = get_post_meta($post->ID, 'week11_audio', true);
...
<a title="Download <?php meta('week11_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week11_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week11_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week11_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week11_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week11_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week11_pdf_id); ?>" href="<?php echo $week11_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week12_audio', true) ) :
$audioMeta12 = get_post_meta($post->ID, 'week12_audio', true);
...
<a title="Download <?php meta('week12_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week12_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week12_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week12_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week12_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week12_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week12_pdf_id); ?>" href="<?php echo $week12_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week13_audio', true) ) :
$audioMeta13 = get_post_meta($post->ID, 'week13_audio', true);
...
<a title="Download <?php meta('week13_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week13_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week13_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week13_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week13_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week13_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week13_pdf_id); ?>" href="<?php echo $week13_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week14_audio', true) ) :
$audioMeta14 = get_post_meta($post->ID, 'week14_audio', true);
...
<a title="Download <?php meta('week14_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week14_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week14_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week14_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week14_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week14_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week14_pdf_id); ?>" href="<?php echo $week14_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week15_audio', true) ) :
$audioMeta15 = get_post_meta($post->ID, 'week15_audio', true);
...
<a title="Download <?php meta('week15_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week15_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week15_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week15_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week15_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week15_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week15_pdf_id); ?>" href="<?php echo $week15_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week16_audio', true) ) :
$audioMeta16 = get_post_meta($post->ID, 'week16_audio', true);
...
<a title="Download <?php meta('week16_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week16_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week16_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week16_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week16_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week16_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week16_pdf_id); ?>" href="<?php echo $week16_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week17_audio', true) ) :
$audioMeta17 = get_post_meta($post->ID, 'week17_audio', true);
...
<a title="Download <?php meta('week17_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week17_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week17_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week17_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week17_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week17_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week17_pdf_id); ?>" href="<?php echo $week17_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week18_audio', true) ) :
$audioMeta18 = get_post_meta($post->ID, 'week18_audio', true);
...
<a title="Download <?php meta('week18_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week18_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week18_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week18_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week18_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week18_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week18_pdf_id); ?>" href="<?php echo $week18_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week19_audio', true) ) :
$audioMeta19 = get_post_meta($post->ID, 'week19_audio', true);
...
<a title="Download <?php meta('week19_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week19_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week19_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week19_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week19_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week19_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week19_pdf_id); ?>" href="<?php echo $week19_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week20_audio', true) ) :
$audioMeta20 = get_post_meta($post->ID, 'week20_audio', true);
...
<a title="Download <?php meta('week20_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week20_audio_file; ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week20_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week20_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week20_vimeo_id') ?>"><img height="20" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week20_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week20_pdf_id); ?>" href="<?php echo $week20_pdf_file; ?>"><img height="20" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
...
<?php
if ( get_post_meta($post->ID, 'week21_audio', true) ) :
$audioMeta21 = get_post_meta($post->ID, 'week21_audio', true);
...
<div class="sermon-media">
<a title="Listen to <?php meta('week21_title') ?>" href="<?php meta('week21_audio') ?>" onclick="popUp(this.href); return false"><img height="21" src="<?php echo get_template_directory_uri(); ?>/images/music.png" /></a>
<a title="Download <?php meta('week21_title') ?>" href="<?php echo get_template_directory_uri(); ?>/download.php?file=<?php echo 
$week21_audio_file; ?>"><img height="21" src="<?php echo get_template_directory_uri(); ?>/images/download.png" /></a>
<?php if ( get_post_meta($post->ID, 'week21_vimeo_id', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php meta('week21_vimeo_title') ?>" href="http://player.vimeo.com/video/<?php meta('week21_vimeo_id') ?>"><img height="21" src="<?php echo get_template_directory_uri(); ?>/images/video.png" /></a>
<?php endif; ?>
<?php if ( get_post_meta($post->ID, 'week21_pdf', true) ) : ?>
<a <?php echo $linkbehavior; ?> title="<?php echo get_the_title($week21_pdf_id); ?>" href="<?php echo $week21_pdf_file; ?>"><img height="21" 
src="<?php echo get_template_directory_uri(); ?>/images/presentation.png" /></a>
<?php endif; ?>
</div>
</div><?php endif; ?>
